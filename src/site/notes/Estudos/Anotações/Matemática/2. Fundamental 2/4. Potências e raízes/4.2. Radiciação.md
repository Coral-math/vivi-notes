...
> [!example]- Passo a passo
> 1. Primeiro fazemos a [[Estudos/Anotações/Matemática/2. Fundamental 2/2. Divisibilidade e múltiplos/Fatoração\|fatoração]] do valor 864, como estamos lidando com uma raiz cúbica, devemos procurar valores ao cubo (grupos de 3):
